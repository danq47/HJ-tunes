...
c DQ - now using updated io framework - need to declare iun
      integer iun
...
c      call lhefreadhdr(97)
c DQ - using new io framework (from RES/b_bbar_4l/main-PYTHIA8.f)
c whereas before iun was set manually as 97 (above and further on in the code)
c we now have to change all the 97s to iun
      ...
      do l=1,maxev
         ...
         call lhefreadev(iun) ! this was (97) but I changed to iun
