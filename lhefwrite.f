...
c DQ mod to manually do tunes reweighting
      if(flg_tunes) then
         ...
         newweight = xwgtup * tune_reweight(H_y, H_pt,
     1        kren_pwg, kfac_pwg, kren_mrt, kfac_mrt)

         write(string,*) '#new weight,renfact,facfact,pdf1,pdf2',newweight,st_renfact
     1        ,st_facfact,pdf_ndns1,pdf_ndns2,' ',whichpdfpk()
